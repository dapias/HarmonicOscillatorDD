...
function thermostatstep!(atoms::Array{Atom,1}, thermo::Thermostat, dt::Float64, N::Int64)
  ...
  n = dim*(N)  #Difference with periodic boundary conditions
  momentasquare = 0.0
...
function run(runtime::Float64, dt::Float64, T::Float64, N::Int64, Q::Float64, thermotype::String)
  ...
  pparticularatom[1] = particularatom.p[1]
  qparticularatom[1] = particularatom.r[1]
...
#  println("0.0")
  ...
  try
    for count in 1:numsteps
      ...
      ####Atom variables
      pparticularatom[count+1] = particularatom.p[1]
      qparticularatom[count+1] = particularatom.r[1]
